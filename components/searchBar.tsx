        ...
        <div >
            ...
            <div className=" flex items-center w-full justify-center">
                <div className=" bg-neutral-100 ">
                    <input type="text" name="Search" placeholder="Search Company" className=" p-3 w-full border-2 border-e-0 border-neutral-300 bg-transparent font-mavenpro outline-none text-xl font-medium rounded-s-xl focus:border-neutral-600 focus:border-e-0" />
                </div>
                <div>
